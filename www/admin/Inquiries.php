<?php
 ...
 $sql="SELECT i.ID,i.UserID,u.Username,i.Name,i.Email,i.ContactNumber,i.Department,i.Message,i.Status,DATE_FORMAT(i.DateAdded, '%M %d %Y') as Added,DATE_FORMAT(i.DateModified, '%M %d %Y') as Modified FROM inquiries i LEFT JOIN users u ON i.UserID=u.ID WHERE i.ID <> 0";
	 ...
	 //if value is not null and deletion form  is submitted
 {
	...
	// echo $keyvalues;
		$sql = "DELETE FROM inquiries WHERE ID IN (".$keyvalues.")";//WHERE ID is in this array means all selected ID's will be deleted together
		// echo $sql;
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <h3 class="box-title">Inquiries Management</h3>
			   <!--Add and Delete buttons-->
			  <button type="button" class="btn btn-block btn-primary" style="width: auto;float: right;" onclick='location.href="AddInquiries.php"'>Add</button>
              ...
              <table id="example2" class="table table-bordered table-hover">
               ...
               <td><?php echo $rows['Email']?></td>
			     <td><?php echo $rows['Message']?></td>
				  ...
				  <td><button type="button" class="btn btn-block btn-primary" style="width: auto;float: right;" onclick='location.href="EditInquiries.php?EID=<?php echo $rows['ID']?>"'>Edit</button></td>
