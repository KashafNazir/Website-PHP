<?php
 ...
 $sql="SELECT u.ID,u.RoleID,r.RoleName,u.Name,u.Password,u.Email,u.CellNumber,u.Username,u.Status,DATE_FORMAT(u.DateAdded, '%M %d %Y') as Added,DATE_FORMAT(u.DateModified, '%M %d %Y') as Modified FROM users u LEFT JOIN roles r ON u.RoleID=r.ID WHERE u.ID <> 0";
	 ...
	 //if value is not null and deletion form  is submitted
 {
	...
	// echo $keyvalues;
		$sql = "DELETE FROM users WHERE ID IN (".$keyvalues.")";//WHERE ID is in this array means all selected ID's will be deleted together
		// echo $sql;
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
			  ...
			  <button type="button" class="btn btn-block btn-primary" style="width: auto;float: right;" onclick='location.href="AddUser.php"'>Add</button>
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
				 ...
				 <td><?php echo $rows['Name']?></td>
				  ...
				  <td><button type="button" class="btn btn-block btn-primary" style="width: auto;float: right;" onclick='location.href="EditUser.php?EID=<?php echo $rows['ID']?>"'>Edit</button></td>
