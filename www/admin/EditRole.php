...
if(isset($_REQUEST['EID']) && ctype_digit($_REQUEST['EID']))
  ...
  //isset Determine if a variable is set and is not NULL && edit form is submitted.
if(isset($_POST['issubmit']) && $_POST['issubmit'] == 'true')
{
	...
	//if user has entered role name then save it in this variable
	if(isset($_POST['RoleName']))
		$RoleName=trim($_POST['RoleName']);
	
	//if role name is empty generate an alert
	if($RoleName == '')
...
{
 $sql = "SELECT ID,RoleName,Status,DATE_FORMAT(DateAdded, '%M %d %Y') as Added,DATE_FORMAT(DateModified, '%M %d %Y') as Modified FROM roles WHERE ID = '".$EID."'";
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit New Role</h3>
			...
			<!--Form for submitting EditRole data-->
			...
			?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Role Name" name="RoleName" value="<?php echo$RoleName; ?>">
                </div>
              </div>            
