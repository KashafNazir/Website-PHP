	...
	//isset Determine if a variable is set and is not NULL && add form is submitted.
{
	...
	//It checks if all of the characters in the provided string, text, are numerical. It checks only 1...9. It returns TRUE if every character in text is a decimal digit, FALSE otherwise.DepID is used for FK(DepID) here as we are selecting department..
...
<head>
  ...
  <title>Admin | Add Proposal</title>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Proposal</h3>
			...
			<!--Form for submitting AddProposal data-->
			...
			?>
				...
				<div class="form-group">
				<!--To select foriegn key from another table--> 
                ...
                <div class="checkbox">
                  <label>
                    <input type="radio" name="IsCompleted" value="1"> Enable
					</label>
					</br>
					<label>
                    <input type="radio"  name="IsCompleted" value="0"> Disable
                  </label>
                </div>
                </div>
